...
from analyst_runtime.config.schema import DingTalkConfig
...
class AnalystRuntimeDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the Analyst Runtime channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to Analyst Runtime via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = AnalystRuntimeDingTalkHandler(self)
    ...
    async def _on_message(self, content: str, sender_id: str, sender_name: str) -> None:
        """Handle incoming message (called by AnalystRuntimeDingTalkHandler).
