...
from analyst_runtime.config.schema import MochatConfig
...
class MochatChannel(BaseChannel):
    ...
    async def stop(self) -> None:
        ...
        if self._socket:
            try:
                ...
                logger.warning("channel mochat socket disconnect error: %s", exc)
            self._socket = None
    ...
    async def _start_socket_client(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.warning("channel mochat client disconnect error: %s", exc)
            self._socket = None
            return False
    ...
    async def _post_json(self, path: str, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            logger.warning("channel mochat JSON parse error: %s", exc)
