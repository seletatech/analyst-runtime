...
class RuntimeProfiles:
    ...
    def _supported_profiles() -> dict[str, type]:
        from analyst_runtime.profiles.manufacturing.profile import ManufacturingSemanticsProfile
    ...
    def _create(cls, name: str, workspace: Path):
        ...
        if profile_type is None:
            raise ValueError(f"Unsupported Analyst Runtime runtime profile: {name!r}")
