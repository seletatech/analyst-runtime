...
from nanobot.agent.skills import get_skill_read_roots
from nanobot.agent.subagent import SubagentManager
from nanobot.agent.tools.analyze_image_tool import AnalyzeImageTool
...
from nanobot.agent.tools.registry import ToolRegistry, register_integration_tools
from nanobot.agent.tools.shell import ExecTool
from nanobot.agent.tools.spawn import SpawnTool
from nanobot.agent.tools.transcription_tool import TranscribeAudioTool
from nanobot.agent.tools.tts_tool import TextToSpeechTool
from nanobot.agent.tools.web import WebFetchTool
from nanobot.bus.events import InboundMessage, OutboundMessage
from nanobot.bus.queue import MessageBus
from nanobot.config.schema import ExecToolConfig
from nanobot.cron.service import CronService
from nanobot.profiles import RuntimeProfiles
from nanobot.profiles.types import ProfileTurnContext
from nanobot.providers.base import LLMProvider
from nanobot.session.manager import HISTORY_SUMMARY_TYPE, Session, SessionManager
...
class AgentLoop:
    ...
    ITERATION_LIMIT_ERROR_CODE = "NANOBOT-ITERATION-001"
    TOOL_PROTOCOL_ERROR_CODE = "NANOBOT-PROTOCOL-001"
    ...
    def __init__(
        ...
        if tool_profile not in {"full", "trusted-analysis"}:
            raise ValueError(f"Unsupported NanoBot tool profile: {tool_profile!r}")
        self.bus = bus
    ...
    # 16,000 matches the upstream nanobot default for max_tool_result_chars.
    ...
    def _composio_credentials_path(self) -> Path:
        return self.workspace / ".nanobot" / "composio" / "credentials.json"
