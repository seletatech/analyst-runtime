...
Analyst Runtime 的 `manufacturing-analyst` system policy、persona 与工具配置。它属于 **manufacturing-analyst workspace** 边界。当前目录不替代父级架构说明，也不接管其他 Module 的数据或安全决策。
...
| 你要做的事情 | 下一步 |
|---|---|
| 查看主要入口或配置 | 打开 [`AGENTS.md`](<AGENTS.md>) |
...
| 文件 | 用途 |
|---|---|
| [`AGENTS.md`](<AGENTS.md>) | 修改前必须阅读的行为/设计约束 |
| [`SOUL.md`](<SOUL.md>) | 修改前必须阅读的行为/设计约束 |
| [`workspace.json`](<workspace.json>) | 本目录的主要实现、配置或受控资料 |
